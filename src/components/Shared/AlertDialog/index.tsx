    ...
    >
      ...
      >
        <S.StyledH1AndP>
          ...
          />
          <Typography as="p" size={sizetext} color={textcolorcontainer}>
            {maintext}
          </Typography>
        </S.StyledH1AndP>
        <S.StyledDivButtons
        ...
        >
          <Button
            ...
            boxshadowbutton={buttons?.confirmbutton?.boxshadowbutton}
            ...
            fontweightbutton={buttons?.confirmbutton?.fontweightbutton}
          />
          <Button
            ...
            fontweightbutton={buttons?.cancelbutton?.fontweightbutton}
          />
        </S.StyledDivButtons>
      </S.StyledDiv>
    </StyleSheetManager>
