...
// Renderers
import { renderChannels, renderInputs } from "./renderers";
...
const Boards = () => {
  ...
  const mappedTableData = formattedEntities.map((row: any) => ({
    ...row,
  ...
  return (
    <S.Container>
      <S.SectionSubtitle>
        <SectionTitle fontSize="var(--md)" title="Monitoramento de Relê" />
      </S.SectionSubtitle>
